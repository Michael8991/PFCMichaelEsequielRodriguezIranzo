...
try {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bindParam(':company_id', $user_company_id, PDO::PARAM_INT);
    $stmt->execute();
    ...
    <div class="home">
        ...
        <div class="home-container">    
            <div class="form-container">
                <form class="addBillForm" id="addBillForm" action="../BillsOPs/insertBill.php" method="POST">
                    <div class="section-form" id="generalDatasSection">
                        <h5>Datos generales</h5>
                        <div class="d-flex w-100">
                            <?php $nombreUsuario = $_SESSION['user']; echo "<p class='align-item-start w-50' style='color:grey; font-size:15px;'> Creado por: <i>" .$nombreUsuario. " </i> </p>"  ?>
                    ...
                    <div class="section-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select ms-1" name="paymentStatus" aria-label="Default select example" required>
                                <option selected>Seleccione el estado de la factura</option>
