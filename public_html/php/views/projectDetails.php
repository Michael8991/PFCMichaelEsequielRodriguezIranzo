...
$user_company_id = $project_company_id = "";

    try{
        $sql = "SELECT CompanyID FROM Users WHERE user = :user";
    ...
    if($resultados){
        $user_company_id = $resultados['CompanyID'];
    }
 if($project_id){
    try{
    ...
    if($resultados){
        $project_company_id = $resultados['CompanyID'];
    }
    ...
    <div class="home">
        ...
        <div class="home-container">    
            <div class="form-container">
                <form class="updateProjectForm" id="updateProjectForm" action="../ProjectsOPs/updateProject.php" method="POST">
                    ...
                    <div class="section-form" id="generalDatasSection">
                        ...
                        <div class="rowBudget">
                            ...
                            <input type="date" class="form-control" id="fechaEmision" name="fechaEmisionInput" value="<?php echo $StartDate ?>" required>
    
                            <label for="fechaValidez">Fecha de validez:</label>
                            <input type="date" class="form-control" id="fechaValidez" name="fechaValidezInput" value="<?php echo $EndDate ?>" required>
                        </div>
                        <div class="rowBudget">
                            ...
                            <input autocomplete="off" class="form-control search-box w-50" type="text" name="searchCustomerInput" id="searchCustomerInput" value="<?php echo $CustomerName ?>" Disabled readonly>
                        ...
                        <div class="rowBudget">
                            ...
                            <input autocomplete="off" class="form-control search-box w-50" type="text" name="proyectNameInput" id="proyectNameInput" value="<?php echo $ProjectName ?>">
                        </div>
                        <div class="rowBudget">
                            <div class="form-floating" style="width: 100% !important">
                                <textarea name="floatingTextarea2" class="form-control col-12" placeholder="Introduce las descripción del proyecto" id="floatingTextarea2" style="height: 100px;"><?php echo $ProjectDescription ?></textarea>
                                <label for="floatingTextarea2">Descripción del proyecto</label>
                            </div>
                        </div>
                        <div class="rowBudget">
                            <label for="proyectPlaceInput">Ubicación del proyecto:</label>
                            <input autocomplete="off" class="form-control search-box w-50" type="text" name="proyectPlaceInput" id="proyectPlaceInput" value="<?php echo $Place ?>">
                        </div>
                        <div class="rowBudget">
                            <label for="proyectPriorityInput">Prioridad del proyecto:</label>
                            <select name="proyectPriorityInput" class="form-select mb-3" aria-label="Large select example" value="<?php echo $ProjectPriority ?>">
                                <option selected>Seleccione la prioridad</option>
                                <option value="Alta" <?php if ($ProjectPriority == "Alta") echo 'selected'; ?> >Alta</option>
                                <option value="Media" <?php if ($ProjectPriority == "Media") echo 'selected'; ?> >Media</option>
                                <option value="Baja" <?php if ($ProjectPriority == "Baja") echo 'selected'; ?> >Baja</option>
                            </select>
                        </div>
                        <div class="rowBudget">
                            <label for="proyectStatusInput">Estado del proyecto:</label>
                            <select name="proyectStatusInput" class="form-select mb-3" aria-label="Large select example">
                                <option value="">Seleccione el estado</option>
                                <option value="En progreso" <?php if ($ProjectStatus == "En progreso") echo 'selected'; ?>>En progreso</option>
                                <option value="Completado" <?php if ($ProjectStatus == "Completado") echo 'selected'; ?>>Completado</option>
                                <option value="Pendiente" <?php if ($ProjectStatus == "Pendiente") echo 'selected'; ?>>Pendiente</option>
                                <option value="Aceptado" <?php if ($ProjectStatus == "Aceptado") echo 'selected'; ?>>Aceptado</option>
                            </select>
                        </div>
                    </div>

                    <div class="rowBudget" style="z-index:2;">
                        <button type="button" class="btn btn-primary btn-success" id="btnSubmitBudgetForm" onclick="openSaveModal()" data-toggle="modal">Actualizar</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-success" form="updateProjectForm">Aceptar</button>
                            </div>
                        </div>
                    </div>
                </div>
