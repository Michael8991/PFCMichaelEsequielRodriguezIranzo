...
try {
    $sqlCompany = "SELECT CompanyID, FirstName, LastName, Email, PhoneNumber, Address FROM Customers WHERE CustomerID = :customerID";
    $stmt = $conn->prepare($sqlCompany);
    ...
    <div class="home">
        ...
        <div class="home-container">    
            <div class="form-container">
                <form class="updateCustomerForm" id="updateCustomerForm" action="../CustomersOPs/updateCustomer.php" method="POST">
                <input type="hidden" name="CustomerID" value="<?php echo $customerID; ?>">
                    <div class="section-form" id="generalDatasSection">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="last_name" value="<?php echo $LastName ?>" name="last_name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="phone_number" value="<?php echo $PhoneNumber ?>" name="phone_number" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-success" form="updateCustomerForm">Aceptar</button>
                            </div>
                        </div>
                    </div>
                </div>
