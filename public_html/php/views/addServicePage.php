    ...
    <div class="home">
        ...
        <div class="home-container">    
            <div class="form-container">
                <form class="addBudgetForm" id="addServiceForm" action="../ServicesOPs/insertService.php" method="POST">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-success" form="addServiceForm">Aceptar</button>
                            </div>
                        </div>
                    </div>
                </div>
