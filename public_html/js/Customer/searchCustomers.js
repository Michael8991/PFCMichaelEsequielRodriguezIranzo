                ...
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    responseArray.forEach(function(record) {
                        ...
                        row.innerHTML = `
                            ...
                            <td>
                                <a class="editar mx-auto text-success" href="customerDetails.php?id=${record.CustomerID}"><i class="fa-regular fa-pen-to-square"></i></a>
                                <a class="borrar me-auto ms-2 text-danger" onclick="deleteCustomer(${record.CustomerID})" data-id="${record.CustomerID}"><i class="fa-solid fa-trash"></i></a>
                            </td>`;
